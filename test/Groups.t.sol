...
contract MockLabUSDT2 is IERC20 {
  string public constant name = "MockLabUSDT"; string public constant symbol = "mLABUSDT"; uint8 public constant decimals = 6;
...
contract GroupsTest is Test {
  MockLabUSDT2 usdc; GroupVault gv; address admin = address(this);
  function setUp() public { usdc = new MockLabUSDT2(); gv = new GroupVault(IERC20(address(usdc)), admin); }
